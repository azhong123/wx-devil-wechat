...
Page({
  ...
  goodsInfoShow: function (success) {
    var that = this;
    wx.request({
      url: 'http://127.0.0.1:8086/api/goods/v1/detail/11',
      method:'GET',
      success: data => {
        var goodsItem = data.data;
        for (var i = 0; i < goodsItem.mainImgUrls.length; i++) {
          imgUrls[i] = goodsItem.mainImgUrls[i];
        }
        ...
        goods = {
          ...
          privilegePrice: goodsItem.price,
          detailImg: detailImg,
          imgUrl: goodsItem.goodsMinImg,
